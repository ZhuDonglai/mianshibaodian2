...
const routes = [
    {
        ...
        children: [
            
			{
			    path: '/interview',
			    name: 'interview',
			    component: () => import('../views/static/interview.vue')
			},
			{
			    path: '/interviewType',
			    name: 'interviewType',
			    component: () => import('../views/static/interviewType.vue')
			},
			{
			    path: '/interviewRemark',
			    name: 'interviewRemark',
			    component: () => import('../views/static/interviewRemark.vue')
			},
